  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("svg", {
        ...
        width: props.width,
        height: props.height
      }, _hoisted_6$1, 8, _hoisted_1$7);
    };
  }
});
const markedRender = (body, loading_img) => {
  const renderer2 = {
...
const lazyloadImage = (img = "img[speak-src]:not([loaded])", attr = "speak-src") => {
    ...
    const io = new IntersectionObserver((entries, Observer) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          const src = img2.getAttribute(attr);
          img2.setAttribute("src", src || "");
          img2.setAttribute("loaded", "loaded");
          Observer.disconnect();
        }
      });
    });
...
var speakCard_vue_vue_type_style_index_0_scoped_true_lang = "";
...
const _hoisted_3$2 = { class: "speak-body-card-footer" };
const _hoisted_4 = /* @__PURE__ */ createTextVNode(" \u8BC4\u8BBA ");
const _hoisted_5 = {
  key: 0,
  class: "speak-body-card-back"
};
const _hoisted_6 = /* @__PURE__ */ createTextVNode(" \u8FD4\u56DE ");
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["showComment", "closeComment"],
  setup(__props, { emit: emits }) {
    const props = __props;
    const userConfig = inject("option");
    const toComment = () => {
      emits("showComment", __spreadValues({}, props.speak));
    };
    const hideComment = () => {
      emits("closeComment", __spreadValues({}, props.speak));
    };
    onMounted(() => {
      /* @__PURE__ */ console.log("\u5B50\u7EC4\u4EF6\u6E32\u67D3\u5B8C\u6210");
      lazyloadImage();
    });
    return (_ctx, _cache) => {
      var _a;
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          innerHTML: unref(markedRender)(props.speak.content, unref(userConfig).loading_img)
        }, null, 8, _hoisted_2$4),
        createBaseVNode("div", _hoisted_3$2, [
          ((_a = props.speak) == null ? void 0 : _a.showComment) === "1" && !unref(userConfig).hideComment && props.showComment ? (openBlock(), createElementBlock("div", {
            key: 0,
            onClick: toComment,
            class: "comments-btn"
          }, [
        ...
        props.showBackBtn ? (openBlock(), createElementBlock("div", _hoisted_5, [
          createBaseVNode("div", {
            class: "back-btn",
            onClick: hideComment
          }, [
...
var SpeakCard = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-210c0f63"]]);
var speakComments_vue_vue_type_style_index_0_scoped_true_lang = "";
const _hoisted_1$5 = { class: "speak-comments" };
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        ...
        createBaseVNode("div", {
          class: normalizeClass(unref(userConfig).commentClass)
        }, null, 2)
      ]);
    };
  }
});
var SpeakComments = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-2e4f9cc8"]]);
var cardLoading_vue_vue_type_style_index_0_lang = "";
const _hoisted_1$4 = { class: "loading-container" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        createBaseVNode("img", {
          src: unref(userConfig).loading_img
        }, null, 8, _hoisted_2$3)
      ]);
    };
  }
});
var speakBody_vue_vue_type_style_index_0_scoped_true_lang = "";
const _hoisted_1$3 = { class: "speak-body" };
const _hoisted_2$2 = {
  key: 1,
  class: "speak-content"
};
const _hoisted_3$1 = { class: "controller" };
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    const hideCommentHandler = (data) => {
      ...
      setTimeout(() => {
        var _a;
        (_a = document.getElementById(data._id)) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth", block: "center" });
      });
    };
    const getSpeakData = () => {
      emits("nextSpeak");
    ...
    onMounted(() => {
      /* @__PURE__ */ console.log("\u7236\u7EC4\u4EF6\u6E32\u67D3\u5B8C\u6210");
      lazyloadImage();
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        speak.value !== null ? (openBlock(), createBlock(Transition, {
          key: 0,
          name: "fade"
        }, {
          default: withCtx(() => [
            createVNode(SpeakComments, {
              speak: speak.value,
              onCloseComment: hideCommentHandler
            }, null, 8, ["speak"])
          ]),
          ...
          createVNode(TransitionGroup, { name: "fade" }, {
            default: withCtx(() => [
              (openBlock(true), createElementBlock(Fragment, null, renderList(props.speakList, (speak2) => {
                return openBlock(), createBlock(SpeakCard, {
                  key: speak2._id,
                  speak: speak2,
          ...
          createBaseVNode("div", _hoisted_3$1, [
            ...
            __props.btnClickFlag && !__props.loading ? (openBlock(), createElementBlock("button", {
              key: 0,
              class: "next-btn",
              onClick: getSpeakData
            }, " \u4E0B\u4E00\u9875 ")) : createCommentVNode("", true)
          ])
        ]))
      ]);
    };
...
var SpeakBody = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-8ef0915a"]]);
const version = "4.4.0";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function goToLogin() {
      ...
      window.location.href = `https://github.com/login/oauth/authorize?client_id=${userConfig.githubClientId}&type=github&redirect_uri=` + currentHref;
    }
    function logout() {
    ...
    return (_ctx, _cache) => {
      return prosp.visitorId ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
        createTextVNode(" \u6B22\u8FCE\u60A8\uFF0C" + toDisplayString(prosp.visitorId === unref(userConfig).author ? "\u535A\u4E3B" : "GitHub\u7528\u6237") + " ", 1),
        createBaseVNode("a", {
          onClick: logout,
          class: "logoutBtn"
        }, "\u9000\u51FA")
...
var speakFooter_vue_vue_type_style_index_0_scoped_true_lang = "";
const _hoisted_1$1 = { class: "speak-footer" };
const _hoisted_2 = /* @__PURE__ */ createTextVNode(" Powered by ");
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      ...
      if (code) {
        const result = await (await fetch(userConfig.api + "api/user/oauth/github?code=" + code)).json();
        if ((_a = result.data) == null ? void 0 : _a.token) {
          window.localStorage.setItem("ispeak-token", result.data.token);
        }
        /* @__PURE__ */ console.log(result);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        unref(userConfig).githubClientId ? (openBlock(), createBlock(_sfc_main$2, {
          key: 0,
          visitorId: prosp.visitorId
        }, null, 8, ["visitorId"])) : createCommentVNode("", true)
      ]);
    };
  }
});
var SpeakFooter = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-dfa83a38"]]);
const _hoisted_1 = {
  class: "xk-speak-container",
  id: "xk-speak-container"
};
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    const getSpeakData = async () => {
      ...
      try {
        loading.value = true;
        const data = await (await fetch(`${url}api/ispeak?author=${axiosGetSpeakParams.author}&page=${axiosGetSpeakParams.page}&pageSize=${axiosGetSpeakParams.pageSize}`, {
        ...
        const { data: tagListResult } = await (await fetch(url + "api/ispeak/tag/list?userId=" + axiosGetSpeakParams.author)).json();
...
async function init(options) {
  return render(__spreadValues(__spreadValues({}, defaultInitOption), options));
}
